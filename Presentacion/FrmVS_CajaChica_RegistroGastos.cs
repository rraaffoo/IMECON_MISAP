...
namespace MISAP
{
    public partial class FrmVS_CajaChica_RegistroGastos : Form, IForm_opciones //, IForm_filtro
    {
        ...
        private object moneda_cod;
        private string ot;
        private object estado_cod;
        private string fecha;
        #endregion

        #region Formulario

        public FrmVS_CajaChica_RegistroGastos()
        {
            InitializeComponent();
        ...
        public FrmVS_CajaChica_RegistroGastos(string pdocEntry)
        {
            InitializeComponent();
            ts_acciones.Renderer = new MyRenderer();
        ...
        //txtdocEntry.Text, txtCaja.Text, txtTotalCaja.Text, cboMoneda.SelectedValue, txtOT.Text, cboEstado.SelectedValue, dtpFecha.Value.ToShortDateString()
        public FrmVS_CajaChica_RegistroGastos(string pdocEntry, string caja, string total_caja, string moneda_cod, string ot, object estado_cod, string fecha)
        {
            InitializeComponent();
            ts_acciones.Renderer = new MyRenderer();
        ...
        public void pasar_valores(string par1, string par2, string par3, string par4, string par5, string par6)
        {
            try
            {
                if (par5 == "Listado de Proveedores")
                {
                    txtProveedorCod.Text = par1;
                    txtProveedorDes.Text = par2;
                }
                if (par5 == "Listado de Impuestos")
                {
                    txtImpuestoCod.Text = par1;
                    txtImpuestoDesc.Text = par2;
                    txtImpuestoCant.Text = par3;
                }
                if (par5 == "Listado de Empleados")
                {
                    txtProveedorCod.Text = par1;
                    txtProveedorDes.Text = par2;
                }
        ...
        {
            txtCaja.Text = caja;
            txtTotalCaja.Text = total_caja;
            cboMonedaCaja.SelectedValue = moneda_cod;
            txtOTCaja.Text = ot;
            cboEstado.SelectedValue = estado_cod;
            dtpFechaCaja.Value = Convert.ToDateTime(fecha);
            cargar_combo_estado();
            cargar_combo_moneda_caja();
            cargar_combo_moneda_gasto();
            cargar_combo_moneda_GNS();
            cargar_combo_tipo_documento();
            cargar_combo_tipoDoc();
            dgvListado.DataSource = Negocio.Listar_CajaChica_Gastos(docEntry);
        ...
        {
            txtSerieDoc.BackColor = SystemColors.Control;
            txtCorrDoc.BackColor = SystemColors.Control;
            txtGastoDesc.BackColor = SystemColors.Control;
            txtProveedorCod.BackColor = SystemColors.Control;
            txtProveedorDes.BackColor = SystemColors.Control;
            txtImpuestoCod.BackColor = SystemColors.Control;
            txtImpuestoDesc.BackColor = SystemColors.Control;
            txtImpuestoCant.BackColor = SystemColors.Control;
            txtTotalDoc.BackColor = SystemColors.Control;
            txtnumDocumento.BackColor = SystemColors.Control;

            txtSerieDoc.ReadOnly = true;
            txtCorrDoc.ReadOnly = true;
            txtGastoDesc.ReadOnly = true;
            ...
            cboMonedaGasto.Enabled = false;
            btnBuscarProveedor.Visible = false;
            btnBuscarImpuesto.Visible = false;
        ...
        private void pasar_dgv_to_txt(int rownum, string tab)
        {
            DataGridViewRow row = dgvListado.Rows[rownum];

            if (tab=="D")
            {
                tabGasto.SelectedTab = tpDocumento;
                
                txtGastoDesc.Text = row.Cells["DESC. GASTO"].Value.ToString();
                //txtProveedorDes.Text = row.Cells["PROVEEDOR"].Value.ToString();
                cboTipoDocumento.SelectedValue = row.Cells["tipDoc"].Value.ToString();
                cboMonedaGasto.SelectedValue = row.Cells["MONEDA_COD"].Value.ToString() == "SOL" ? "1" : "2";
                dtpFecha.Value = Convert.ToDateTime(row.Cells["FECHA DOC."].Value.ToString());
                txtSerieDoc.Text = row.Cells["SERIE DOC."].Value.ToString();
                txtCorrDoc.Text = row.Cells["CORRELATIVO DOC."].Value.ToString();
                txtTotalDoc.Text = row.Cells["TOTAL DOC."].Value.ToString();
                txtProyecto.Text = row.Cells["PROYECTO"].Value.ToString();
                txtOTGasto.Text = row.Cells["OT"].Value.ToString();
                txtdocEntry.Text = row.Cells["docEntry"].Value.ToString();
                txtProveedorCod.Text = row.Cells["codProv"].Value.ToString();
                txtProveedorDes.Text = row.Cells["PROVEEDOR"].Value.ToString();
                txtImpuestoCod.Text = row.Cells["IMPcodigo"].Value.ToString();
                txtImpuestoDesc.Text = row.Cells["IMPnombre"].Value.ToString();
                txtImpuestoCant.Text = Math.Round(Convert.ToDecimal(row.Cells["IMPcantidad"].Value.ToString())).ToString();
            }
            if (tab == "G")
            {
                tabGasto.SelectedTab = tpGasto;

                txtTotalGNS.Text = row.Cells["TOTAL DOC."].Value.ToString();
                cboMonedaGNS.SelectedValue = row.Cells["MONEDA_COD"].Value.ToString() == "SOL" ? "1" : "2";
                dtpFechaGNS.Value = Convert.ToDateTime(row.Cells["FECHA DOC."].Value.ToString());
                txtEmpleadoCodGNS.Text = row.Cells["codEmp"].Value.ToString();
                txtEmpleadoDescGNS.Text = row.Cells["nomEmp"].Value.ToString();
                txtPlanillaGNS.Text = row.Cells["numPlan"].Value.ToString();
                txtComentarioGNS.Text = row.Cells["nomComentario"].Value.ToString();
                txtDescripcionGNS.Text = row.Cells["DESC. GASTO"].Value.ToString();
            }
            
        }

        private void cargar_combo_moneda_caja()
        {
            ...
            cboMonedaCaja.DataSource = dt;
            cboMonedaCaja.ValueMember = "Codigo";
            cboMonedaCaja.DisplayMember = "Descripcion";

        }

        private void cargar_combo_moneda_gasto()
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("Codigo");
            dt.Columns.Add("Descripcion");
            ...
            cboMonedaGasto.DataSource = dt;
            cboMonedaGasto.ValueMember = "Codigo";
            cboMonedaGasto.DisplayMember = "Descripcion";

        }

        private void cargar_combo_moneda_GNS()
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("Codigo");
            dt.Columns.Add("Descripcion");
            ...
            cboMonedaGNS.DataSource = dt;
            cboMonedaGNS.ValueMember = "Codigo";
            cboMonedaGNS.DisplayMember = "Descripcion";
        ...
        private void cargar_combo_tipoDoc()
        {
            DataTable dt = new DataTable();
            dt.Columns.Add("Codigo");
            dt.Columns.Add("Descripcion");
        ...
        void formatear_grilla(DataGridView grilla)
        {
            try
            {
                ...
                grilla.Columns["tipDoc"].Visible = false;
                ...
                grilla.Columns["monGasto"].Visible = false;
                ...
                grilla.Columns["docEntry"].Visible = false;
                grilla.Columns["MONEDA_COD"].Visible = false;
                //grilla.Columns["monto"].DefaultCellStyle.Format = "#";
                grilla.Columns["SERIE DOC."].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                grilla.Columns["CORRELATIVO DOC."].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
                grilla.Columns["TOTAL DOC."].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void dgvListado_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                pasar_dgv_to_txt(e.RowIndex, dgvListado.Rows[e.RowIndex].Cells["tipGasto"].Value.ToString());
            }
        }


        private void cboMonedaCaja_DrawItem(object sender, DrawItemEventArgs e)
        {
            util.FormatearCombo(sender, e, "Descripcion");
        }

        private void cboMonedaCaja_Enter(object sender, EventArgs e)
        {
            cboMonedaCaja.BackColor = Color.FromArgb(254, 240, 158);
        }

        private void cboMonedaCaja_Leave(object sender, EventArgs e)
        {
            cboMonedaCaja.BackColor = Color.White;
        }
        ...
        private void cboMonedaGasto_DrawItem(object sender, DrawItemEventArgs e)
        {
            util.FormatearCombo(sender, e, "Descripcion");
        }

        private void cboMonedaGasto_Enter(object sender, EventArgs e)
        {
            cboMonedaGasto.BackColor = Color.FromArgb(254, 240, 158);
        }

        private void cboMonedaGasto_Leave(object sender, EventArgs e)
        {
            cboMonedaGasto.BackColor = Color.White;
        }

        private void dgvListado_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            FrmVS_GastoMantenimiento Gasto = new FrmVS_GastoMantenimiento(txtdocEntry.Text);
            Gasto.docEntryGC = txtdocEntry.Text;
            Gasto.impuesto = txtImpuestoCant.Text;
            Gasto.pcodProy = txtProyecto.Text;
            Gasto.pOt = txtOTGasto.Text;
            Gasto.ShowDialog();
        }
        ...
        private void btnBuscarProveedor_Click(object sender, EventArgs e)
        {
            ...
            opciones.titulo = "Listado de Proveedores";
            opciones.ShowDialog(this);
        }

        private void txtbuscarImpuesto_Click(object sender, EventArgs e)
        {
            FrmVS_Opciones opciones = new FrmVS_Opciones();
            opciones.titulo = "Listado de Impuestos";
            opciones.ShowDialog(this);
        }

        private void btnNuevo_Click(object sender, EventArgs e)
        {
            txtSerieDoc.BackColor = SystemColors.Window;
            txtCorrDoc.BackColor = SystemColors.Window;
            txtGastoDesc.BackColor = SystemColors.Window;
            txtProveedorCod.BackColor = SystemColors.Window;
            txtProveedorDes.BackColor = SystemColors.Window;
            txtImpuestoCod.BackColor = SystemColors.Window;
            txtImpuestoDesc.BackColor = SystemColors.Window;
            txtImpuestoCant.BackColor = SystemColors.Window;
            txtTotalDoc.BackColor = SystemColors.Window;
            txtnumDocumento.BackColor = SystemColors.Window;

            txtSerieDoc.Text = "";
            txtCorrDoc.Text = "";
            txtGastoDesc.Text = "";
            txtProveedorCod.Text = "";
            txtProveedorDes.Text = "";
            txtImpuestoCod.Text = "";
            txtImpuestoDesc.Text = "";
            txtImpuestoCant.Text = "";
            txtTotalDoc.Text = "";
            txtnumDocumento.Text = "";

            txtSerieDoc.ReadOnly = false;
            txtCorrDoc.ReadOnly = false;
            txtGastoDesc.ReadOnly = false;
            txtTotalDoc.ReadOnly = false;
            ...
            cboMonedaGasto.Enabled = true;
            btnBuscarProveedor.Visible = true;
            btnBuscarImpuesto.Visible = true;
        ...
        {
            configuracion_inicial_controles();
            DialogResult resul = MessageBox.Show("Si elimina el Gasto, también eliminará los artículos asociados. ¿Está seguro que quiere eliminar este Gasto?", "Eliminar Gasto", MessageBoxButtons.YesNo);
            if (resul == DialogResult.Yes)
            {
                try
                {
                    Negocio.VS_OOGC_Eliminar(Convert.ToInt32(txtdocEntry.Text), 0);
                    dgvListado.DataSource = Negocio.Listar_CajaChica_Gastos(docEntry);
                    formatear_grilla(dgvListado);
                    util.mensaje("Se Eliminó el Gasto de manera exitosa", true, lbl_contador_registros, lbl_msg, ss_load, t_msg);
                }
                catch (Exception ex)
                {
        ...
        {
            configuracion_inicial_controles();
            string mon = cboMonedaGasto.SelectedValue.ToString() == "1" ? "SOL" : "DOL";
            try
            {
                if (flagOperacion == "nuevo")
                {
                    Negocio.VS_OOGC_RegMod(0, "D", txtGastoDesc.Text, txtProveedorCod.Text, txtProveedorDes.Text, cboTipoDoc.SelectedValue.ToString(), txtnumDocumento.Text, cboTipoDocumento.SelectedValue.ToString(), txtSerieDoc.Text, txtCorrDoc.Text, Convert.ToDecimal(txtTotalDoc.Text), dtpFecha.Value, mon, 0, 0, 0, "", caja, txtImpuestoCod.Text, txtImpuestoDesc.Text, Convert.ToDecimal(txtImpuestoCant.Text), "", "", "", "", txtProyecto.Text, txtOTGasto.Text, 0);
                    dgvListado.DataSource = Negocio.Listar_CajaChica_Gastos(docEntry);
                    formatear_grilla(dgvListado);
        ...
        private void cboTipoDocumento_DrawItem(object sender, DrawItemEventArgs e)
        {
            util.FormatearCombo(sender, e, "Descripcion");
        }
        ...
        {
            cboTipoDocumento.BackColor = Color.FromArgb(254, 240, 158);
        }
        ...
        private void cboTipoDoc_DrawItem(object sender, DrawItemEventArgs e)
        {
            util.FormatearCombo(sender, e, "Descripcion");
        }

        private void cboTipoDoc_Enter(object sender, EventArgs e)
        {
            cboTipoDoc.BackColor = Color.FromArgb(254, 240, 158);
        }

        private void cboTipoDoc_Leave(object sender, EventArgs e)
        {
        ...
        {
            FrmVS_AsignarFechaConta fechaCont = new FrmVS_AsignarFechaConta(docEntry);
            fechaCont.Show();
        }
        ...
        {
            FrmVS_Opciones opciones = new FrmVS_Opciones();
            opciones.titulo = "Listado de Empleados";
            opciones.ShowDialog(this);
        }

        private void cboMonedaGNS_DrawItem(object sender, DrawItemEventArgs e)
        {
            util.FormatearCombo(sender, e, "Descripcion");
        }

        private void cboMonedaGNS_Enter(object sender, EventArgs e)
        {
            cboMonedaGNS.BackColor = Color.FromArgb(254, 240, 158);
        }

        private void cboMonedaGNS_Leave(object sender, EventArgs e)
        {
            cboMonedaGNS.BackColor = Color.White;
        }
