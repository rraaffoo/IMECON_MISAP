...
namespace MISAP
{
    ...
    public partial class FrmInformeSegAceros : Form, IForm_parametrizacion, IForm_Listado
    {
        ...
        public void pasar_valores(string par1, string par2, string par3, string par4, string par5, string par6)
        {
            try
            {
                    if (par5 == "Lista de Ordenes de trabajo")
                    {
                        ...
                        btn_CargarProg.BackgroundImage = ((System.Drawing.Image)(Properties.Resources.btn_enfasis));
                        btn_CargarProg.Enabled = true;
                        btn_faltante.BackgroundImage = ((System.Drawing.Image)(Properties.Resources.btn_enfasis));
                        btn_faltante.Enabled = true;
                    }
        ...
        void inicializar()
        {
            ...
            dgv_lista.DataSource = AccesoLogica.informe_seguimiento_aceros("Detallado", txt_PrcCode.Text);
            formatear_grilla(dgv_lista);
        ...
        private void btn_CargarProg_Click(object sender, EventArgs e)
        {

            FrmProgAceros progaceros = new FrmProgAceros();
            progaceros.usuario = usuario;
            progaceros.perfil = perfil;
            progaceros.PrcCode = txt_PrcCode.Text;
            progaceros.U_CL_DESCRI = txt_U_CL_DESCRI.Text;
            progaceros.flag_pr_falt = btn_CargarProg.Text;
            progaceros.ShowDialog(this);
        }

        private void btn_faltante_Click(object sender, EventArgs e)
        {
            FrmProgAceros faltaceros = new FrmProgAceros();
            faltaceros.usuario = usuario;
            faltaceros.perfil = perfil;
            faltaceros.PrcCode = txt_PrcCode.Text;
            faltaceros.U_CL_DESCRI = txt_U_CL_DESCRI.Text;
            faltaceros.flag_pr_falt = btn_faltante.Text;
            faltaceros.ShowDialog(this);
        }
        ...
        private void chk_agrupar_CheckedChanged(object sender, EventArgs e)
        {
            dgv_lista.DataSource = null;
            if (chk_agrupar.Checked == true)
            {
        ...
        private void tsm_detalle_Click(object sender, EventArgs e)
        {
            ...
            FrmInformeSegAcerosDet segacerosdet = new FrmInformeSegAcerosDet();
            segacerosdet.usuario = usuario;
            segacerosdet.perfil =  perfil;
            segacerosdet.ot = txt_PrcCode.Text;
            segacerosdet.Show();
