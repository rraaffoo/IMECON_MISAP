...
namespace MISAP
{
    public partial class CrvCargoDoc : Form
    {
        ...
        private void CrvCargoDoc_Load(object sender, EventArgs e)
        {
            this.Location = new System.Drawing.Point(10, 90);
            reporte();
        }
        ...
        private void reporte()
        {
            try
            {
                ...
                RptCargo reporte = new RptCargo();
                reporte.SetDatabaseLogon("sa", "B1Admin", "SAPIMECONSERVER", "MISAP");
                reporte.SetParameterValue("@NroLote", NroLote);
                reporte.SetParameterValue("@operacion", "Consultar");
                reporte.SetParameterValue("@tipo", "Consultar");
                crv_cargo.ReportSource = reporte;
