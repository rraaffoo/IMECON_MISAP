...
namespace MISAP
{
    public partial class FrmVS_GestionUsuarios : Form, IForm_opciones //, IForm_filtro
    {
        ...
        public FrmVS_GestionUsuarios()
        {
            InitializeComponent();
            ts_acciones.Renderer = new MyRenderer();
        }
        public FrmVS_GestionUsuarios(string pproyecto)
        {
            InitializeComponent();
            ts_acciones.Renderer = new MyRenderer();
            proyecto = pproyecto;
        ...
        public void pasar_valores(string par1, string par2, string par3, string par4, string par5, string par6)
        {
            try
            {
                if (par5 == "Listado de Usuarios")
                {
                    txtCodigo.Text = par1;
                    txtNombre.Text = par2;
                    txtCorreo.Text = par3;
                }
                if (par5 == "Listado de Proyectos VS")
                {
                    txtProyecto.Text = par2;
                    txtProyectoCod.Text = par1;                    
                }
                if (par5 == "Listado de Roles")
                {
                    txtRol.Text = par2;
                    txtRolCod.Text = par1;                    
                }
        ...
        private void FrmPedidos_Load(object sender, EventArgs e)
        {
            //cargar_combo_moneda();
            cargar_combo_estado();
            dgvListado.DataSource = Negocio.VS_Listar_Usuarios("grilla");
        ...
        private void configuracion_inicial_controles()
        {
            ...
            txtProyectoCod.BackColor = SystemColors.Control;
            txtRol.BackColor = SystemColors.Control;
            txtRolCod.BackColor = SystemColors.Control;
        ...
        private void pasar_dgv_to_txt(int rownum)
        {
            ...
            txtProyecto.Text = row.Cells["DESC. PROYECTO"].Value.ToString();
            txtProyectoCod.Text = row.Cells["CODIGO PROYECTO"].Value.ToString();
            txtRol.Text = row.Cells["DESC. ROL"].Value.ToString();
            txtRolCod.Text = row.Cells["CODIGO ROL"].Value.ToString();
        }
        ...
        void formatear_grilla(DataGridView grilla)
        {
            try
            {
                ...
                grilla.Columns["CODIGO PROYECTO"].Visible = false;
                grilla.Columns["DESC. PROYECTO"].Visible = false;
                grilla.Columns["CODIGO ROL"].Visible = false;
                grilla.Columns["DESC. ROL"].Visible = false;
        ...
        private void btnBuscarUsuario_Click(object sender, EventArgs e)
        {
            ...
            opciones.titulo = "Listado de Usuarios";
        ...
        {
            FrmVS_Opciones opciones = new FrmVS_Opciones();
            opciones.titulo = "Listado de Proyectos VS";
            opciones.ShowDialog(this);
        }
        ...
        {
            FrmVS_Opciones opciones = new FrmVS_Opciones();
            opciones.titulo = "Listado de Roles";
            opciones.ShowDialog(this);
        }
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            //txtProyectoCod.BackColor = SystemColors.Window;
            //txtRol.BackColor = SystemColors.Window;
            //txtRolCod.BackColor = SystemColors.Window;
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Negocio.VS_RegMod_Usuario(txtCodigo.Text, txtNombre.Text, txtCorreo.Text, "A");
                    dgvListado.DataSource = Negocio.VS_Listar_Usuarios("grilla");
                    formatear_grilla(dgvListado);
                ...
                {
                    Negocio.VS_RegMod_Usuario(txtCodigo.Text, txtNombre.Text, txtCorreo.Text, cboEstado.SelectedValue.ToString());
                    dgvListado.DataSource = Negocio.VS_Listar_Usuarios("grilla");
                    formatear_grilla(dgvListado);
                    util.mensaje("Se modificó el registro de manera exitosa", true, lbl_contador_registros, lbl_msg, ss_load, t_msg);
                }

                if (flagOperacion == "asignar")
                {
                    Negocio.VS_Asignar_Proyecto_Usu(txtCodigo.Text, txtProyectoCod.Text, txtRolCod.Text,"A");
                    dgvListado.DataSource = Negocio.VS_Listar_Usuarios("grilla");
                    formatear_grilla(dgvListado);
                    util.mensaje("Se asignó de manera exitosa", true, lbl_contador_registros, lbl_msg, ss_load, t_msg);
                }
            }
            catch (Exception ex)
            {
        ...
        private void btnAsignarPy_Click(object sender, EventArgs e)
        {
            //txtCodigo.BackColor = SystemColors.Window;
            //txtNombre.BackColor = SystemColors.Window;
            //txtCorreo.BackColor = SystemColors.Window;
            ...
            btnModificar.Enabled = false;
            btnSuprimir.Enabled = false;
            btnAsignarPy.Enabled = false;

            //btnBuscarUsuario.Visible = true;
            btnBuscarProyecto.Visible = true;
            btnBuscarRol.Visible = true;

            flagOperacion = "asignar";
            dgvListado.Enabled = false;
        }
        ...
        private void btnSuprimir_Click(object sender, EventArgs e)
        {
            ...
            if (resul == DialogResult.Yes)
            {
                ...
                try
                {
                    Negocio.VS_RegMod_Usuario(txtCodigo.Text, txtNombre.Text, txtCorreo.Text, "X");
                    dgvListado.DataSource = Negocio.VS_Listar_Usuarios("grilla");
                    formatear_grilla(dgvListado);
                    util.mensaje("Se anuló el registro de manera exitosa", true, lbl_contador_registros, lbl_msg, ss_load, t_msg);
                }
                catch (Exception ex)
                {
                    util.mensaje("Error: " + ex.Message, false, lbl_contador_registros, lbl_msg, ss_load, t_msg);
